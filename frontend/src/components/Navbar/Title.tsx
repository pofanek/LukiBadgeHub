...
const Title = ({
  ...
  return (
    <Link
      to="/"
      className={`flex h-full shrink-0 items-center duration-300 hover:scale-105 hover:cursor-pointer ${longNavbar ? "ml-2 w-42 gap-2 max-[379px]:w-12 max-[379px]:gap-0 sm:ml-0 lg:w-auto lg:gap-4" : "w-67 justify-center gap-6"} `}
    >
      <NavbarImage
