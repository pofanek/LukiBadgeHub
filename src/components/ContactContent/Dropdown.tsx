...
const Dropdown = () => {
  ...
  return (
    <div
      className={`bg-surface relative flex max-w-full flex-1 flex-col rounded-2xl text-xl lg:max-w-[80%]`}
    >
      <button
        type="button"
      ...
      <div
        className={`bg-surface absolute top-full z-10 mt-1.5 w-full rounded-2xl transition-opacity duration-200 ease-in-out ${isDropdownOpen ? "opacity-100" : "pointer-events-none opacity-0"}`}
      >
        <DropdownItem
